...
const CommentModal = ({ post, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white/80 backdrop-blur-2xl w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] max-h-[85vh] flex flex-col border border-white/80"
      ...
      >
        ...
        <div className="mx-5 mb-4 flex items-start gap-3 bg-stone-50/50 backdrop-blur-sm rounded-2xl px-4 py-3 border border-stone-200/50">
    ...
    {dayjs(comment.createdAt).fromNow()}
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-t border-stone-100">
          <Image
            ...
            alt="you"
          />
          <div className="flex-1 flex items-center gap-2 bg-stone-50/50 backdrop-blur-sm rounded-2xl px-4 py-2.5 border border-stone-200/50 focus-within:bg-white focus-within:border-amber-300 focus-within:ring-2 focus-within:ring-amber-100/50 transition-all shadow-inner">
            <input
              ref={postInput}
              onChange={(e) => {
