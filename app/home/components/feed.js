      ...
      {posts.map((post) => {
        return (
          <article
            ...
            className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/80 p-4 px-3 sm:p-5 shadow-[0_8px_30px_rgb(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300"
          >
