  ...
  return (
    ...
    >
      <div
        ...
        className="min-h-screen md:pl-28"
      >
        <div className="max-w-5xl mx-auto px-4 py-20 flex gap-6 items-start">
          <main className="flex-1 min-w-0 max-w-[560px]">
            <div className="bg-white/60 backdrop-blur-xl rounded-3xl border border-white/80 p-4 shadow-[0_8px_30px_rgb(0,0,0,0.06)] mb-5">
